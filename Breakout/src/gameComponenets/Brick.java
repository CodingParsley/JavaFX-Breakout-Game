...
public class Brick extends Rectangle{
	...
	//Main constructor
	protected Brick(Coordinate topLeft, Coordinate bottomRight, int id, RectangleType type, int hitCount, int hitResistance) {
	...
	public Brick hitBrick(){
		return new Brick(this.getTopLeftCoordinate(), this.getBottomRightCoordinate(),
				this.getId(), this.getType(), this.hitCount+1, this.hitResistance);
	}
	public Brick chisel(){
